...
import url from 'https://fonts.googleapis.com/css2?family=Lexend:wght@100..900&display=swap';
const Banner = () => {
    return (
        <div className='max-w-7xl mx-auto  '>
            <div className="hero ">
     <img src={img} alt="" className='h-4/5 w-full rounded-3xl brightness-50 url' />
