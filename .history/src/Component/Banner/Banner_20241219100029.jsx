...
const Banner = () => {
  ...
  <div className="hero-content text-center w-3/5 ">
    <div className="">
      <h1 className="text-5xl font-bold text-white liner">Discover an exceptional cooking class tailored for you!</h1>
...
Thank you for visiting and I hope you enjoy my recipes.
     ...
     <button className="btn bg-[#0BE58A] rounded-full border-none">Explore Now</button>
      ...
      <button className=" border-2 p-2 rounded-full bg-none text-white">Our Feedback</button>
     </div>
    </div>
  </div>
</div>
