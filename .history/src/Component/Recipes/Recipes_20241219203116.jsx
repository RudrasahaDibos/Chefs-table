...
const Recipes = () => {
    ...
    const [RecipeCookCalories, setRecipeCookCalories] = useState(0)
    ...
    const handlePreparing = (time,calories,item) =>{
          const newcookready = [...currentlycook , item]
          setcurrentlycook(newcookready)
        const newpreparingtime = Recipecooktime + time
        const newPreparingcalories = RecipeCookCalories + calories
         setRecipeCookCalories(newPreparingcalories)
        ...
        <div>
            ...
            <div className="md:flex flex-cols justify-around max-w-7xl mx-auto ">
                ...
                <div className="md:w-1/3 w-full ">
                    ...
                    <div className="divider"></div>
                    <h1 className="text-2xl text-center font-bold">Currently cooking :{currentlycook.length}</h1>
                      <CookCart currentlycook={currentlycook} Recipecooktime={Recipecooktime} RecipeCookCalories={RecipeCookCalories}></CookCart>
                </div>
            </div>
        </div>
    );
