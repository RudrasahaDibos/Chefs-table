...
const Recipe = ({recipe,handleAdd }) => {
    ...
    return (
        <div>
            <div className="card bg-base-100 md:w-96 w-80  shadow-xl mt-4">
               ...
               <div className="flex  justify-around w-full">
                      <h1 className="flex justify-center items-center gap-2"><DiFirefox/> <p>{preparing_time} minmuites </p></h1>
